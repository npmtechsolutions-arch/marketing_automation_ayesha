              ...
              <div className="flex-1">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white font-medium">Click "Invite Member"</p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white font-medium">Copy the Invitation Link</p>
                      <p className="text-xs text-gray-400 mt-0.5">
                        After sending, an <strong className="text-white">invitation link</strong> will appear on screen. Click <strong className="text-purple-300">"Copy Invitation Link"</strong> and send it to your team member via WhatsApp, email, or any messaging app.
                      </p>
                    </div>
                  </div>
                  {/* Step 3 */}
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white font-medium">Team Member Registers & Accepts</p>
                      <p className="text-xs text-gray-400 mt-0.5">
                        The invited person must first <strong className="text-white">register an account</strong> at this app using the <strong className="text-white">same email address</strong> you invited. After registering and logging in, they open the invitation link — they will be added to your team automatically.
                      </p>
                    </div>
                  </div>
                  {/* Note */}
                  <div className="flex items-start gap-2 mt-1 pt-3 border-t border-white/10">
            ...
            {activeMembers.length === 0 && (
              <GlassCard>
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-400 text-sm">No active members yet.</p>
                  <p className="text-gray-500 text-xs mt-1">Invite your first team member to get started.</p>
                </div>
              </GlassCard>
            )}
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <p className="text-white font-medium">{getMemberName(member)}</p>
                            {member.role === "owner" && <Crown className="w-4 h-4 text-amber-400" />}
                          </div>
                          <p className="text-sm text-gray-400">{getMemberEmail(member)}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3">
                  ...
                  <GlassCard padding="sm" className="!border-dashed !border-white/15">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <p className="text-white font-medium">{getMemberEmail(member)}</p>
            ...
            <div className="space-y-4">
              <div className="flex flex-col items-center py-4 gap-3">
                ...
                <p className="text-gray-400 text-sm text-center">
                  Share this link with <strong className="text-white">{inviteEmail}</strong> so they can join your team.
                </p>
              </div>
              ...
              {inviteLink ? (
                <div className="space-y-2">
                  <div className="flex items-center gap-2 p-3 rounded-xl bg-white/5 border border-white/10">
                    ...
                    <p className="text-xs text-gray-300 flex-1 break-all font-mono">{inviteLink}</p>
                  </div>
                  <button
                    onClick={copyLink}
                    className={cn(
        ...
        {selectedMember && (
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/10">
              ...
              <div>
                <p className="text-white font-medium text-sm">{getMemberName(selectedMember)}</p>
                <p className="text-gray-400 text-xs">{getMemberEmail(selectedMember)}</p>
              </div>
            </div>
