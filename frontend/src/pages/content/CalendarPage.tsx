...
// ---------- Mock Data ----------
function generateMockPosts(): CalendarPost[] {
  const now = new Date();
  ...
  return [
    {
      ...
      content:
        "We're thrilled to announce our latest feature update! Boost your marketing efficiency with AI-powered scheduling and analytics. Try it today and see the difference. #MarketingAutomation #AI #ProductLaunch",
      platform: "facebook",
      status: "published",
      date: new Date(year, month, 2, 9, 0),
      hour: 9,
      minute: 0,
      durationHours: 1,
      imageUrl: "/placeholder.jpg",
      engagement: { likes: 245, comments: 38, shares: 67, views: 3400 },
    },
    {
      id: "2",
      title: "Behind the Scenes",
      content:
        "A sneak peek at our design process. Our team works tirelessly to bring you the best marketing tools. #BehindTheScenes #TeamWork",
      platform: "instagram",
      status: "published",
      date: new Date(year, month, 3, 12, 30),
      hour: 12,
      minute: 30,
      durationHours: 1,
      imageUrl: "/placeholder.jpg",
      engagement: { likes: 512, comments: 89, shares: 34, views: 6200 },
    },
    {
      id: "3",
      title: "Industry Insights Report",
      content:
        "Our latest report on marketing automation trends is out. Key findings: 78% of marketers plan to increase automation spending in 2026. Read the full report on our blog.",
      platform: "linkedin",
      status: "published",
      ...
      minute: 0,
      durationHours: 1,
      engagement: { likes: 189, comments: 42, shares: 156, views: 8900 },
    },
    {
      id: "4",
      title: "Quick Tip Tuesday",
      content:
        "Quick tip: Schedule your posts during peak engagement hours. Our AI can find the best times for YOUR audience. #MarketingTips #SocialMedia",
      platform: "twitter",
      status: "published",
      date: new Date(year, month, 7, 14, 0),
      hour: 14,
      minute: 0,
      durationHours: 1,
      engagement: { likes: 97, comments: 15, shares: 43, views: 2100 },
    },
    {
      id: "5",
      title: "Tutorial Video: Automated Campaigns",
      content:
        "Learn how to set up your first automated campaign in under 5 minutes! Full tutorial on our YouTube channel.",
      platform: "youtube",
      status: "published",
      date: new Date(year, month, 8, 15, 0),
      hour: 15,
      minute: 0,
      durationHours: 2,
      imageUrl: "/placeholder.jpg",
      engagement: { likes: 340, comments: 67, shares: 89, views: 12000 },
    },
    {
      id: "6",
      title: "Customer Success Story",
      content:
        "See how @TechStartup increased their social engagement by 340% using our platform. Full case study on our blog! #CustomerSuccess",
      platform: "facebook",
      status: "scheduled",
      date: new Date(year, month, 12, 9, 0),
      hour: 9,
      minute: 0,
      durationHours: 1,
      imageUrl: "/placeholder.jpg",
    },
    {
      ...
      content: "Something big is coming next week... Stay tuned! #ComingSoon #Innovation",
      platform: "instagram",
      status: "scheduled",
      date: new Date(year, month, 14, 11, 0),
      hour: 11,
      minute: 0,
      durationHours: 1,
      imageUrl: "/placeholder.jpg",
    },
    {
      ...
      content:
        "Join our free webinar on 'Maximizing ROI with Marketing Automation' this Thursday at 2 PM EST. Register now!",
      platform: "linkedin",
      status: "scheduled",
      date: new Date(year, month, 15, 8, 0),
      hour: 8,
      minute: 0,
      durationHours: 1,
    },
    {
      id: "9",
      title: "Poll: Best Platforms for ROI",
      content:
        "Which social platform drives the most ROI for your business? Vote below! #SocialMediaMarketing #Poll",
      platform: "twitter",
      status: "scheduled",
      date: new Date(year, month, 18, 13, 0),
      hour: 13,
      minute: 0,
      durationHours: 1,
    },
    {
      ...
      content:
        "Complete walkthrough of our new analytics dashboard. See how to track your campaigns in real-time.",
      platform: "youtube",
      status: "scheduled",
      date: new Date(year, month, 20, 16, 0),
      hour: 16,
      minute: 0,
      durationHours: 2,
      imageUrl: "/placeholder.jpg",
    },
    {
      ...
      content: "Happy Friday! What's your biggest marketing win this week? Share below!",
      platform: "facebook",
      status: "draft",
      date: new Date(year, month, 10, 17, 0),
      hour: 17,
      minute: 0,
      durationHours: 1,
    },
    {
      id: "12",
      title: "Infographic: 10 Stats for 2026",
      content:
        "10 Statistics Every Marketer Should Know in 2026. #Infographic #MarketingStats",
      platform: "instagram",
      status: "draft",
      date: new Date(year, month, 16, 10, 0),
      hour: 10,
      minute: 0,
      durationHours: 1,
      imageUrl: "/placeholder.jpg",
    },
    {
      ...
      content:
        "The future of marketing is conversational. Here's why brands need to embrace AI-driven personalization now.",
      platform: "linkedin",
      status: "draft",
      date: new Date(year, month, 22, 9, 0),
      hour: 9,
      minute: 0,
      durationHours: 1,
    },
    {
      id: "14",
      title: "Thread: Automation Hacks",
      content:
        "Thread: 5 underrated marketing automation features that can save you 10+ hours per week. Let's dive in...",
      platform: "twitter",
      status: "draft",
      date: new Date(year, month, 25, 11, 0),
      hour: 11,
      minute: 0,
      durationHours: 1,
    },
    {
      ...
      content:
        "Check out our latest blog post on content strategy for Q2 2026. Link in bio!",
      platform: "facebook",
      status: "failed",
      date: new Date(year, month, 6, 10, 0),
      hour: 10,
      minute: 0,
      durationHours: 1,
    },
    {
      id: "16",
      title: "Stories Content: Templates",
      content:
        "Swipe up to see our new template library! Over 200 customizable templates for every platform.",
      platform: "instagram",
      status: "failed",
      date: new Date(year, month, 9, 14, 0),
      hour: 14,
      minute: 0,
      durationHours: 1,
      imageUrl: "/placeholder.jpg",
    },
    {
      ...
      content:
        "March recap: All the features, updates, and improvements we shipped this month. Watch now!",
      platform: "youtube",
      status: "scheduled",
      date: new Date(year, month, 28, 10, 0),
      hour: 10,
      minute: 0,
      durationHours: 2,
      imageUrl: "/placeholder.jpg",
    },
    {
      ...
      content:
        "Shoutout to our amazing community of 50K+ marketers! You make this platform better every day.",
      platform: "twitter",
      status: "scheduled",
      date: new Date(year, month, 26, 15, 0),
      hour: 15,
      minute: 0,
      durationHours: 1,
    },
    {
      ...
      content:
        "How to use AI to write better social media copy in half the time. Our 5-step framework inside.",
      platform: "linkedin",
      status: "published",
      date: new Date(year, month, 4, 11, 0),
      hour: 11,
      minute: 0,
      durationHours: 1,
      engagement: { likes: 312, comments: 58, shares: 124, views: 7800 },
    },
    {
      id: "20",
      title: "Reel: Quick Setup Guide",
      content:
        "Set up your first campaign in 60 seconds flat. Watch this quick guide! #Reels #MarketingAutomation",
      platform: "instagram",
      status: "scheduled",
      date: new Date(year, month, 19, 12, 0),
      hour: 12,
      minute: 0,
      durationHours: 1,
      imageUrl: "/placeholder.jpg",
